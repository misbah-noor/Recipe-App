...
return(
    ...
    <div className='bg-white rounded-xl shadow-2xl overflow-hidden'>
      ...
      <div className='p-6 flex flex-col justify-center items-center'>
        ...
        <button className='px-4 py-3 bg-red-500 rounded-lg w-full text-white my-5 hover:bg-red-600 cursor-pointer'><Link to={`/recipe/${recipes.id}`}>View Details</Link></button>   
       </div>   
    </div>
