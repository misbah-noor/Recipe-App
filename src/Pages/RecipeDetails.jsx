...
const RecipeDetails =() => {
   ...
   return(
    ...
    <div className="mx-auto px-10 pt-8 sm:pt-25 flex sm:gap-25 gap-10 flex-wrap container flex-col sm:flex-row justify-center items-center pb-10">
      ...
      <h3 className="flex gap-2 items-center text-2xl font-semibold mb-2 text-[#fe8b2e]"><FaClipboardList />Ingredients:</h3>
      <ul className="text-neutral-900 list-disc pl-5 mb-4">
        {recipe.ingredients.map((item, index) => <li key={index}>{item}</li>)}
     </ul>
     <h3 className="text-2xl font-semibold mb-2 text-[#fe8b2e] flex items-center gap-2"><PiCookingPotDuotone />Instructions:</h3>
